...
import deepmerge from '/Users/kaiyu.kong/kaiyu.kong/util/react-laziness-image/node_modules/deepmerge';
  ...
  Object.values(routes).forEach((route) => {
    ...
    if (routeMeta) {
      if (
        ...
        (route.meta?.frontmatter?.debug || routeMeta.frontmatter?.debug)
      ) {
